...
const Formulario = ()=>{
    ...
    return(
        <section className={"flex flex-row justify-center items-center mx-40 my-0 mt-5 object-contain border-2 border-purple-600 border-spacing-4 px-20 py-20 bg-blue-200"}>
